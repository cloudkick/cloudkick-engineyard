...
SRC_URI="
    x86?    ( http://packages.cloudkick.com/releases/${PN}/binaries/${PN}-${PV}_engineyard_i386.tar.gz )
    amd64?	( http://packages.cloudkick.com/releases/${PN}/binaries/${PN}-${PV}_engineyard_amd64.tar.gz )"
